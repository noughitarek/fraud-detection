...
from evaluation.evaluate_lr import evaluate_lr
from evaluation.evaluate_dt import evaluate_dt
from evaluation.evaluate_rf import evaluate_rf
from evaluation.evaluate_xg import evaluate_xg
import warnings
warnings.filterwarnings("ignore")
st.set_option('deprecation.showPyplotGlobalUse', False)

st.set_page_config(page_title="Training without sampling", page_icon="🖥️", layout='centered')
st.title("Training without sampling")
st.write()
