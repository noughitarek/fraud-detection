...
from evaluation.evaluate_lr_smote import evaluate_lr
from evaluation.evaluate_dt_smote import evaluate_dt
from evaluation.evaluate_rf_smote import evaluate_rf
from evaluation.evaluate_xg_smote import evaluate_xg
import warnings
warnings.filterwarnings("ignore")
st.set_option('deprecation.showPyplotGlobalUse', False)

st.set_page_config(page_title="Training using SMOTE oversampling", page_icon="📈", layout='centered')
st.title("Training using SMOTE oversampling")
st.write()
